...
public class DeleteComputer extends AsyncTask<ComputerEntity, Void, Void> {
    private static final String TAG = "DeleteComputer";

    private Application mApplication;
    private OnAsyncEventListener mCallBack;
    private Exception mException;

    public DeleteComputer(Application application, OnAsyncEventListener callback) {
